...
class LogIn(APIView):
    ...
    def post(self, request):
        ...
        if user:
            ...
            return Response({"error: worng password or username"},status=status.HTTP_400_BAD_REQUEST)
...
class GithubLogIn(APIView):
    ...
    def post(self, request):
        try:
            ...
            access_token = requests.post(f"https://github.com/login/oauth/access_token?code={code}&client_id=Ov23liI4Hk3luFVeheb5&client_secret={settings.GH_SECRET}",
